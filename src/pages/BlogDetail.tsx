        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <aside className="hidden lg:block lg:col-span-2">
            <div className="sticky top-24 h-fit">
              <h3 className="text-sm font-bold uppercase tracking-wider text-slate-700 dark:text-slate-100 mb-4 px-3">Table of Contents</h3>
              {toc.length === 0 ? (
                  ...
                  {toc.map((t) => {
                    ...
                    return (
                      <a
                        ...
                        className={
                          isActive
                            ? 'flex items-center gap-3 px-3 py-2 rounded-lg bg-primary/10 text-primary border-l-4 border-primary font-semibold transition-all'
                            : 'flex items-center gap-3 px-3 py-2 rounded-lg text-slate-900 dark:text-slate-100 hover:bg-slate-100/70 dark:hover:bg-slate-800/70 transition-all'
                        }
                      >
