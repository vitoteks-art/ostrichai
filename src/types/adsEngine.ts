...
export interface ProductInput {
    name: string;
    productUrl?: string; // Optional URL field
    description: string;
    targetAudience: string;
    adPlatforms?: string;
    competitors: string;
    competitorUrl?: string; // Optional URL field
}
...
export interface FinalCampaignConfig {
    ...
    // 2. Ad Set Settings
    adSetName: string;
    conversionLocation: string; // WEBSITE, APP, MESSAGING_APPS, etc.
...
export interface AppState {
    ...
    finalAd?: AdCreative | null;
    finalConfig?: FinalCampaignConfig | null; // Detailed Meta settings
    projectId?: string;
}
