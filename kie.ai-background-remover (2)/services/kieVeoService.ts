...
import { KieVeoGeneratePayload, KieVeoExtendPayload, VeoPollResult } from '../types';

const N8N_CREATE_WEBHOOK_URL = 'https://n8n.vitotek.com.ng/webhook-test/ugc';
const N8N_STATUS_WEBHOOK_URL = 'https://n8n.vitotek.com.ng/webhook/ugc-status';
const N8N_EXTEND_WEBHOOK_URL = 'https://n8n.vitotek.com.ng/webhook-test/extend-video';
