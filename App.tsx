...
import { Layers, Image as ImageIcon, Wand2, Settings, History, Plus, Link as LinkIcon, Upload as UploadIcon, X, Video, Clapperboard, Palette } from 'lucide-react';
...
const DEFAULT_CLOUDINARY_PRESET = 'OstrichAi';
...
const App: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'image' | 'video' | 'flyer'>('image');
        ...
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className={`p-2 rounded-lg shadow-lg ${
                ...
                'bg-gradient-to-br from-pink-600 to-rose-600 shadow-pink-600/20'
            }`}>
              <Layers size={20} className="text-white" />
            </div>
            <h1 className="font-bold text-xl tracking-tight text-slate-800">
              OstrichAi<span className={
